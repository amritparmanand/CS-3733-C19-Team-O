 ...
 * the License.
 */
package OCR.Tess4J.src.net.sourceforge.tess4j;
...
import OCR.Tess4J.Lept4J.src.net.sourceforge.lept4j.Box;
import OCR.Tess4J.Lept4J.src.net.sourceforge.lept4j.Boxa;
import static OCR.Tess4J.Lept4J.src.net.sourceforge.lept4j.ILeptonica.L_CLONE;
import OCR.Tess4J.Lept4J.src.net.sourceforge.lept4j.Leptonica;
 ...
 */
public class Tesseract implements OCR.Tess4J.src.net.sourceforge.tess4j.ITesseract {
    ...
    private OCR.Tess4J.src.net.sourceforge.tess4j.TessAPI api;
     ...
     * @return api
     */
    protected OCR.Tess4J.src.net.sourceforge.tess4j.TessAPI getAPI() {
        return api;
    }
     ...
     */
    @Override
    public String doOCR(File imageFile) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     */
    @Override
    public String doOCR(File imageFile, Rectangle rect) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        try {
            return doOCR(ImageIOHelper.getIIOImageList(imageFile), imageFile.getPath(), rect);
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
            throw new OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException(e);
        }
    }
     ...
     */
    @Override
    public String doOCR(BufferedImage bi) throws net.sourceforge.tess4j.TesseractException, OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     */
    @Override
    public String doOCR(BufferedImage bi, Rectangle rect) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        try {
     ...
     */
    @Override
    public String doOCR(List<IIOImage> imageList, Rectangle rect) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     */
    @Override
    public String doOCR(List<IIOImage> imageList, String filename, Rectangle rect) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        init();
        setTessVariables();
     ...
     */
    @Override
    public String doOCR(int xsize, int ysize, ByteBuffer buf, Rectangle rect, int bpp) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     */
    @Override
    public String doOCR(int xsize, int ysize, ByteBuffer buf, String filename, Rectangle rect, int bpp) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        init();
        setTessVariables();
     ...
     */
    protected void init() {
        api = OCR.Tess4J.src.net.sourceforge.tess4j.TessAPI.INSTANCE;
     ...
     */
    @Override
    public void createDocuments(String filename, String outputbase, List<RenderedFormat> formats) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     */
    @Override
    public void createDocuments(String[] filenames, String[] outputbases, List<RenderedFormat> formats) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
     ...
     * @throws TesseractException
     */
    private void createDocuments(String filename, TessResultRenderer renderer) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        ...
        if (result == OCR.Tess4J.src.net.sourceforge.tess4j.ITessAPI.FALSE) {
            throw new OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException("Error during processing page.");
        }
    }
     ...
     */
    @Override
    public List<Rectangle> getSegmentedRegions(BufferedImage bi, int pageIteratorLevel) throws OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException {
        init();
        setTessVariables();
        ...
        try {
            ...
            // skip the problematic image
            logger.error(ioe.getMessage(), ioe);
            throw new OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException(ioe);
        } finally {
            dispose();
        }
    }
     ...
     */
    @Override
    public List<OCR.Tess4J.src.net.sourceforge.tess4j.Word> getWords(BufferedImage bi, int pageIteratorLevel) {
        this.init();
        this.setTessVariables();

        List<OCR.Tess4J.src.net.sourceforge.tess4j.Word> words = new ArrayList<OCR.Tess4J.src.net.sourceforge.tess4j.Word>();
        ...
        try {
            ...
            do {
                ...
                OCR.Tess4J.src.net.sourceforge.tess4j.Word word = new OCR.Tess4J.src.net.sourceforge.tess4j.Word(text, confidence, new Rectangle(left, top, right - left, bottom - top));
                words.add(word);
