...
public class L_Rcha extends Structure {
	 ...
	 * C type : Numa*
	 */
	public L_Rcha(net.sourceforge.lept4j.Numa.ByReference naindex, net.sourceforge.lept4j.Numa.ByReference nascore, Sarray.ByReference satext, net.sourceforge.lept4j.Numa.ByReference nasample, net.sourceforge.lept4j.Numa.ByReference naxloc, net.sourceforge.lept4j.Numa.ByReference nayloc, net.sourceforge.lept4j.Numa.ByReference nawidth) {
		super();
