...
public interface ITesseract {
     ...
     */
    String doOCR(File imageFile) throws TesseractException, OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException;
     ...
     * @throws TesseractException
     */
    String doOCR(File imageFile, Rectangle rect) throws TesseractException, OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException;
     ...
     * @throws TesseractException
     */
    String doOCR(BufferedImage bi) throws TesseractException, net.sourceforge.tess4j.TesseractException;
     ...
     * @throws TesseractException
     */
    String doOCR(List<IIOImage> imageList, Rectangle rect) throws TesseractException, TesseractException;
     ...
     * @throws TesseractException
     */
    String doOCR(int xsize, int ysize, ByteBuffer buf, String filename, Rectangle rect, int bpp) throws TesseractException, OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException;
     ...
     * @throws TesseractException
     */
    List<Rectangle> getSegmentedRegions(BufferedImage bi, int pageIteratorLevel) throws TesseractException, OCR.Tess4J.src.net.sourceforge.tess4j.TesseractException;
