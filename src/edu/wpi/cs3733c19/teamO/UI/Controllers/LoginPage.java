...
//                    buf = buf.trim();
                    ...
                    if ((buf != null && !(buf.length() < 4))) {
                        ...
                        if ((uname != null) && (uname != "")) {
                            ...
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/aHomepage.fxml"));
                            Platform.runLater(() -> {
    ...
    public void register() throws IOException {
        if (m.isSelected()) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/mRegister.fxml"));
            sceneM.changeScene(loader, new mRegister(sceneM, cacheM));
        } else if (a.isSelected()) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/aRegister.fxml"));
