...
public class SearchPage {
    ...
    @FXML public void loadAlcohol(ArrayList<SearchResult> searchList) {
        ...
        for(SearchResult result: searchList) {
            try {
                alcResult = FXMLLoader.load(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/alcBox.fxml"));
...
//                            SearchResultPopup searchResultPopup = new SearchResultPopup();
                            root = FXMLLoader.load(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/SearchResultPopup.fxml"));
