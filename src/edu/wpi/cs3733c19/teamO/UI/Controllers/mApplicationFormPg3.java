...
import edu.wpi.cs3733c19.teamO.Datatypes.LabelImage;
import edu.wpi.cs3733c19.teamO.UI.MultiThreadWaitFor;
import edu.wpi.cs3733c19.teamO.UI.callableFunction;
...
//            imagePreview.setImage(form.getLabel().getLabelImage());
    ...
    */
    @FXML public void nextPage() throws IOException {
        saveDraft();
        System.out.println("on to page 4");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/mApplicationFormPg4.fxml"));
        sceneM.changeScene(loader, new mApplicationFormPg4(sceneM, cacheM));
    }
    @FXML public void previousPage() throws IOException {
        multiThreadWaitFor.onShutDown();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/mApplicationFormPg2.fxml"));
    ...
    @FXML public void goToHomePage() throws IOException {
        multiThreadWaitFor.onShutDown();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/mHomepage.fxml"));
