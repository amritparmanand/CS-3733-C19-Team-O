...
import edu.wpi.cs3733c19.teamO.Datatypes.Agent;
import edu.wpi.cs3733c19.teamO.Datatypes.Form;
import edu.wpi.cs3733c19.teamO.Datatypes.NumberAssigned;
...
public class aFormStorage {
    ...
    public void assignNewForms() throws IOException {
        ...
        for (Form form : populatedForms) {
            ...
            try {
                formResult = FXMLLoader.load(getClass().getResource("/edu/wpi/cs3733c19/teamO/UI/Views/alcBox.fxml"));
