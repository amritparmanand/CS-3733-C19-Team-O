...
//
//                for (int i = 0; i < srArr.size(); i++) {
//                    SearchResult sr = srArr.get(0);
//                    //holder variable to hold the type of alcohol for printing
//                    writer.println(sr.getFancifulName() + delimi +
//                            sr.getCompanyName() + delimi +
//                            sr.getAlcoholType() + delimi +
//                            sr.getAlcoholType() + delimi +
//                            sr.getPhLevel() + delimi +
//                            sr.getAlcohol() + delimi +
//                            sr.getYear());
//                }
//
//                writer.close();
